            ...
            if return_ids:
                ...
                for rto in return_ids:
                    if rto:
                        ...
                        ws.write(row, 3, 'Online Sale Through Pay. Rec. by Flipkart (HI)')
                        ws.write(row, 4, 'Online Sale Through Pay. Rec. by Flipkart (HI)')
                        ...
                        # ws.write(row, 28, 'Output Tax -SGST@ '+str(cgst)+'%' if rto.invoice_order_id.partner_id.vat[0:2] == rto.invoice_order_id.warehouse_id.gstin[0:2] else '')
                        ...
                        ws.write(row, 49, rto.invoice_order_id.invoice_number_b2b)
                        ws.write(row, 50, rto.invoice_order_id.sale_number_b2b)
