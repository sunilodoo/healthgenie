...
class ProductProduct(models.Model):
	...
	categ1 = fields.Many2one('product.category1', string='Product Category1')
	categ2 = fields.Many2one('product.category2', string='Product Category-2')
	categ3 = fields.Many2one('product.category3', string='Product Category-3')
	sale_type = fields.Selection([
        ('assemble_packing', 'Assemble-Packing'),
        ('import', 'Import'),
        ('mfg', 'Mfg'),
